 ...
 * @author Truong ND
 */
public class AddStudentbyClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //them sinh vien theo lop mon hoc
            ...
            String ma_mon_hoc = request.getParameter("txtmamonhoc");
            ...
            bean.setMa_mon_hoc(ma_mon_hoc);
            
            studentByClassDAO.create(bean);
            
            RequestDispatcher dispatch = getServletContext().
                    getRequestDispatcher("/ListClass");
